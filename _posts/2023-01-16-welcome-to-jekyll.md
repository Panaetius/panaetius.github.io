...
Renaming the files to have the `.img` extension and opening them with [GMapTool](https://www.gmaptool.eu/en/content/linux-version) confirms that they are indeed Garmin
maps:
